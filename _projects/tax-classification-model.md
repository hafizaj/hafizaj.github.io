...
description: "A supervised ML model classifying financial transactions for tax treatment — built from scratch on site, replacing an external vendor entirely."
...
- Invested most of the effort in **feature engineering** — the signal was in
  how transaction attributes combined, not in any single field
...
- The vendor contract was ended — the capability now lives in-house
